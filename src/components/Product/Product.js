  ...
  return (
    <Gr1>
      ...
      <Div2>
        ...
        {props.show ? (
          <div>
            ...
            <Button
              ...
              startIcon={<EditIcon />}
            >
              <NavLink to={`/add-product/${props.id}?edit=true`} exact>
                edit{" "}
              </NavLink>
            </Button>
          </div>
        ...
        {props.showButton ? (
          <RegBtns>
            <SumBtns color="secondary" onClick={props.subtraction}>
              <RemoveIcon style={{ fontSize: 30 }} />
            </SumBtns>
            <div>{props.yourAmount}</div>
            <SumBtns color="secondary" size="small" onClick={props.addition}>
              <SumIcon style={{ fontSize: 30 }} />
            </SumBtns>
          </RegBtns>
        ) : null}
      </Div2>
