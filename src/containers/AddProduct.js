...
class AddProduct extends Component {
  ...
  componentDidMount() {
    ...
    if (this.editMode) {
      axios.get("http://localhost:5003/user/products/" + id).then((res) => {
  ...
  editHandler = () => {
    ...
    if (this.editMode) {
      ...
      axios
        .put(`http://localhost:5003/user/products/edit/${id}`, data, {
          headers: {
  ...
  postHandler = () => {
    ...
    data.append("type", this.state.type);
    axios
      .post("http://localhost:5003/user/post-product", data, {
        headers: {
          Authorization: "bearer " + this.props.token,
        },
      })
      ...
      <MyGrid>
          ...
          <CustInput
            ...
            onChange={(event) =>
              this.setState({
                ...
                priceYourAmount: event.target.value,
              })
            }
            id="standard-number"
            label="Price"
        ...
        <FormControl>
          ...
          >
            ...
            <CustOption value="tungsten lamp">tungsten lamp</CustOption>
            <option
              style={{ color: "white", backgroundColor: "black" }}
              value="halogenous lamp"
            >
              halogenous lamp
            </option>
